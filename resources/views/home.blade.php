            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row" align="center">
                        ...
                        <div class="col-sm" style="padding-bottom: 1rem">
                            <a class="btn btn-primary btn-block" data-toggle="tooltip" data-placement="top" title="" href="reportes"><label style="font-size: 2rem; font-weight: bolder;">Reportes</label> 
                            <br><i class="fas fa-file-contract" style="font-size: 5rem;"></i>
                            </a>
                        </div>
                        @endif
